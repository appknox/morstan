<template>
  <div id="device-connect">
    <section class="deviceconnect">
      ...
      <!-- Connect inputs -->
      <input class="deviceconnect__input" type="text" v-model="url" placeholder="Device URL">
      <input class="deviceconnect__input" type="text" v-model="token" placeholder="Token">
